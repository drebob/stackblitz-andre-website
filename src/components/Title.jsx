  ...
  return (
    <section id="titledescription" className={`flex md:flex-row flex-col`}>
      <div className={`flex-1 ${styles.flexStart} flex-col`}>
        ...
        Expert in digital design with <a href="adobe.com" className="font-semibold text-white hover:text-teal-300" target="blank" aria-label="Official Adobe Website(opens in new tab)">Adobe Suite</a> and <a href="https://openai.com/" className="font-semibold text-white hover:text-teal-300" aria-label="Official ChatGPT Website(opens in new tab)" target="_blank">AI</a>, along with modern front-end technologies like <a href="https://tailwindcss.com/" className="font-semibold text-white hover:text-teal-300" target="_blank" aria-label="Official Tailwind Documentation(opens in new tab)">Tailwind CSS</a>, <a href="https://react.dev/" className="font-semibold text-white hover:text-teal-300" aria-label="Official React Documentation (opens in new tab)" target="_blank">React</a>, and <a href="https://jquery.com/" className="font-semibold text-white hover:text-teal-300" target="_blank" aria-label="Official jQuery Website(opens in new tab)">jQuery</a>.
        </p>
      </div>
