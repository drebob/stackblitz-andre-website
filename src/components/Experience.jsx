const Experience = () => (
  <section
  id="experience"
  className="mt-24  scroll-mt-16 lg:scroll-mt-24"
  aria-label="Work experience"
>
  <div className="sticky top-0 z-20 -ml-12 mb-4 w-screen bg-slate-900/75 px-12 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
            ...
            <h3 className="font-medium leading-snug text-slate-200">
              <div>
                <a
                  ...
                  href="https://brownies.com"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="Web Designer/Developer at Fairytale Brownies (opens in a new tab)"
                >
          ...
          <div className="z-10 sm:col-span-6">
            <h3 className="font-medium leading-snug text-slate-200">
              <div>
                <a
                  className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base"
                  href="https://www.petosa.com"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="Lead Web Developer at Petosa (opens in a new tab)"
                >
                  <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                  <span>
                    Lead Web Developer ·{" "}
          ...
          <div className="z-10 sm:col-span-6">
            <h3 className="font-medium leading-snug text-slate-200">
              <div>
                <a
                  className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base"
                  href="https://www.berkadia.com/"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="Designer at Berkadia"
                >
                  <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                  <span>
          ...
          <div className="z-10 sm:col-span-6">
            <h3 className="font-medium leading-snug text-slate-200">
              <div>
                <a
                  className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base"
                  href="https://retail1031.com/"
                  target="_blank"
                  rel="noreferrer noopener"
                  aria-label="Retail 1031 Commercial Real Estate Company (opens in a new tab)"
                >
