...
const About = () =>  (
  <section id="about" className={'flex md:flex-row flex-col pt-24'}>
    ...
    <div className={layout.sectionInfo}>
      ...
      My journey in graphic and web design started with personalizing my MySpace profile and evolved into a career crafting digital experiences for diverse industries. I’ve designed and developed websites for <a href="retail1031.com" className="font-semibold text-white" target="_blank" aria-label="Retail 1031 (opens in a new tab)">commercial real estate</a>, a <a href="" className="font-semibold text-white" target="_blank" aria-label="Petosa Accordions (opens in a new tab)">century-old accordion manufacturer</a>, and most recently <a href="brownies.com" className="font-semibold text-white" target="_blank" aria-label="Fairytale Brownies(opens in a new tab)">brownies.com</a>.
      </p>
