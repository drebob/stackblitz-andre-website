...
const About = () =>  (
  <section id="about" className={'flex flex-col pt-24'}>
    ...
    <div className={layout.sectionInfo}>
      <p className={`font-poppins font-normal text-white text-[17.5px] leading-[26.8px]`}>
      ...
      <p className={`font-poppins font-normal text-white text-[17.5px] leading-[26.8px] mt-5`}>
