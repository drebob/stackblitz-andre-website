        ...
        <div className={`lg:flex lg:justify-between lg:gap-4`}>
          ...
          <div className={'lg:w-1/2 lg:pb-24 xl:mb-9"'}>
            ...
            <section id="background" className={'flex flex-col invisible h-0 pt-0 md:visible md:pt-24 md:h-auto'}>
              <div className="sticky top-0 z-20 -ml-12 mb-4 w-screen bg-slate-900/75 px-12 py-4 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:px-0 lg:py-0 lg:opacity-0">
            ...
            <div className={'w-1/2 m-auto pt-16 text-dimWhite leading-6 text-sm'}>
              <p>Built with <a href="https://tailwindcss.com/" className="font-semibold hover:text-teal-300" target="_blank" aria-label="Tailwind Documentation (opens in new tab)">Tailwind CSS</a>, <a href="https://react.dev/" className="font-semibold hover:text-teal-300" aria-label="Official React Documentation (opens in new tab)" target="_blank">React</a>, and <a href="https://particles.js.org/" className="font-semibold hover:text-teal-300" aria-label="Official tsParticles Documentation (opens in new tab)">tsParticles</a>. Coded in <a href="https://code.visualstudio.com/" className="font-semibold hover:text-teal-300" aria-label="Official Visual Studio Code Website(opens in new tab)" target="_blank">Visual Studio Code</a> within the <a href="https://stackblitz.com/" className="font-semibold hover:text-teal-300" target="_blank" aria-label="Official StackBlitz Website(opens in new tab)">StackBlitz</a> online development environment. Deployed with <a href="https://vercel.com/" className="font-semibold hover:text-teal-300">Vercel.</a>  </p>
            </div>
          </div>
        </div>
      </div>
